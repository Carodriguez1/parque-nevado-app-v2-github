            ...
            <br>
              ...
              <div class="row">
                <div class="col-lg-12">
                    ...
                    <form method="POST" action="{{route('clientes.store')}}" class="row g-3 needs-validation" novalidate>
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <select class="form-select  @error('tipo_doc') is-invalid @enderror" id="tipo_doc" name="tipo_doc" autocomplete="tipo_doc">
                                    <option value="CC">{{__('Cedula de ciudadanía')}}</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input type="text" class="form-control @error('numero_doc') is-invalid @enderror" id="numero_doc" name="numero_doc" value="{{ old('numero_doc') }}" autocomplete="numero_doc" autofocus maxlength="10">
                                @error('numero_doc')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input type="email" class="form-control @error('correo') is-invalid @enderror" id="correo" name="correo" value="{{ old('correo') }}" autocomplete="correo" autofocus>
                                @error('correo')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input type="text" class="form-control @error('telefono') is-invalid @enderror" id="telefono" name="telefono" value="{{ old('telefono') }}" autocomplete="telefono" autofocus>
                                @error('telefono')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        @enderror
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input type="text" class="form-control @error('departamento') is-invalid @enderror" id="departamento" name="departamento" value="{{ old('departamento') }}" autocomplete="departamento" autofocus>
                                @error('departamento')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        @enderror
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input type="text" class="form-control @error('ciudad') is-invalid @enderror" id="ciudad" name="ciudad" value="{{ old('ciudad') }}" autocomplete="ciudad" autofocus>
                                @error('ciudad')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input type="text" class="form-control @error('direccion') is-invalid @enderror" id="direccion" name="direccion" value="{{ old('direccion') }}" autocomplete="direccion" autofocus>
                                @error('direccion')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input type="date" class="form-control @error('fecha_nacimiento') is-invalid @enderror" id="fecha_nacimiento" name="fecha_nacimiento" value="{{ old('fecha_nacimiento') }}" autocomplete="fecha_nacimiento" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input type="text" class="form-control @error('edad') is-invalid @enderror" id="edad" name="edad" value="{{ old('edad') }}" autocomplete="edad" autofocus>
                                @error('edad')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                      ...
                      <div class="col-12">
                        <button type="submit" class="btn btn-primary w-100" type="submit">{{ __('Agregar') }}</button>
                      </div>
                      <div class="col-12">
