            ...
            <br>
              ...
              <div class="row">
                <div class="col-lg-12">
                    ...
                    <form method="POST" action="{{route('reservas.store')}}" class="row g-3 needs-validation" novalidate>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input type="date" class="form-control @error('fecha_reserva') is-invalid @enderror" id="fecha_reserva" name="fecha_reserva" value="{{ old('fecha_reserva') }}" autocomplete="fecha_reserva" autofocus>
                                @error('fecha_reserva')
                        ...
                        @enderror
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input type="time" class="form-control @error('hora') is-invalid @enderror" name="hora_reserva" value="{{ old('hora_reserva') }}" required autocomplete="hora_reserva">
                                @error('hora_reserva')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        @enderror
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input type="number" class="form-control @error('numero_personas') is-invalid @enderror" id="numero_personas" name="numero_personas" value="{{ old('numero_personas') }}" autocomplete="numero_personas" autofocus maxlength="10">
                        ...
                        @enderror
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input type="number" class="form-control @error('mayores_18') is-invalid @enderror" id="mayores_18" name="mayores_18" value="{{ old('mayores_18') }}" autocomplete="mayores_18" autofocus maxlength="10">
                                @error('mayores_18')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        @enderror
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input type="number" class="form-control @error('menores_18') is-invalid @enderror" id="menores_18" name="menores_18" value="{{ old('menores_18') }}" autocomplete="menores_18" autofocus maxlength="10">
                                @error('menores_18')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        @enderror
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input type="number" class="form-control @error('valor_reserva') is-invalid @enderror" id="valor_reserva" name="valor_reserva" value="{{ old('valor_reserva') }}" required autocomplete="nombre" autofocus>
                                @error('valor_reserva')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
